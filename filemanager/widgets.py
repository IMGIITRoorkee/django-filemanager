...
class CKEditorWidget(forms.Textarea):
    ...
    def render(self, name, value, attrs=None):
        ...
        return rendered + mark_safe(div + u"""<script type="text/javascript">document.addEventListener('DOMContentLoaded', function() { CKEDITOR.replace('%s',%s); }, false); </script> """ % (attrs['id'], self.config))
